...
def template_context_sample(request):
    ...
    return render(request, "sample/template_context.html", {
        "title" : title,
...
def template_example(request):
    ...
    return render(request, "sample/template_example.html", {
        "title" : title,
        "num" : num,
        "names" : names,
    })
...
def top_sample(request):
    return render(request, "sample/top_sample.html", {
        "title" : "トップページ",
    })
 
def user_sample(request):
    return render(request, "sample/user_sample.html", {
        "title" : "ユーザー設定",
    })
 
def privacy_sample(request):
    return render(request, "sample/privacy_sample.html", {
        "title" : "プライバシーポリシー",
    })
 
def login_sample(request):
    return render(request, "sample/login_sample.html", {
        "title" : "ログイン",
    })
 
 
def signup_sample(request):
    return render(request, "sample/signup_sample.html", {
        "title" : "サインアップ",
    })
...
def show_profile(request):
    return render(request, "sample/show_profile.html", {
        "title" : "サインアップ",
    })
    
def get_post_sample(request):
    return render(request, "sample/get_post_sample.html", {
        "title" : "GETとPOSTのサンプル",
...
def url_parameter_sample(request, id, comment_id):
    return render(request, "sample/url_parameter_sample.html", {
...
def show_item(request, id, comment_id, price_id, item_name_id):
    return render(request, "sample/show_item.html", {
...
def model_sample(request):
    ...
    return render(request, "sample/model_sample.html", {
        "title" : "モデルの使いかた",
        "message" : message,
    })
...
def message_list(request):
    ...
    return render(request, "sample/message_list.html", {
        "title" : "一言掲示板",
        "messages" : messages,
    })
...
def message_detail(request, id):
    ...
    return render(request, "sample/message_detail.html", {
...
def message_update(request, id):
    ...
    if request.method == "POST":
        ...
        message.save()
        # 詳細ページへリダイレクト
        return redirect(f"/sample/message_detail/{message.id}")
 
    return render(request, "sample/message_update.html", {
        "title" : f"id: {id} のメッセージ",
        "message" : message,
    })
...
def message_delete(request, id):
    ...
    # 一覧ページへリダイレクト
    return redirect("/sample/message_list/")
...
def message_create(request):
    ...
    return render(request, "sample/message_create.html", {
        "title" : "新規投稿",
    })
